...
#define SPI2_SCK_ETH_Pin GPIO_PIN_13
#define SPI2_SCK_ETH_GPIO_Port GPIOB
#define SPI2_MISO_ETH_Pin GPIO_PIN_14
#define SPI2_MISO_ETH_GPIO_Port GPIOB
#define SPI2_MOSI_ETH_Pin GPIO_PIN_15
#define SPI2_MOSI_ETH_GPIO_Port GPIOB
